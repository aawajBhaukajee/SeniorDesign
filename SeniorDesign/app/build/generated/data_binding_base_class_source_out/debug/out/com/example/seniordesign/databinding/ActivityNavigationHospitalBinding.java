...
public final class ActivityNavigationHospitalBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView showdateH;

  @NonNull
  public final TextView shownameH;
  ...
  public static ActivityNavigationHospitalBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.iH;
      TextView iH = rootView.findViewById(id);
      if (iH == null) {
        break missingId;
      }
      ...
      id = R.id.showdateH;
      TextView showdateH = rootView.findViewById(id);
      if (showdateH == null) {
        break missingId;
      }

      id = R.id.shownameH;
      TextView shownameH = rootView.findViewById(id);
      if (shownameH == null) {
        break missingId;
      }

      id = R.id.showtimeH;
      TextView showtimeH = rootView.findViewById(id);
      if (showtimeH == null) {
        break missingId;
      }
