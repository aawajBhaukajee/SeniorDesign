...
public final class SplashScreenBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView donorlogo;

  private SplashScreenBinding(@NonNull RelativeLayout rootView, @NonNull ImageView donorlogo) {
    this.rootView = rootView;
    this.donorlogo = donorlogo;
  }
  ...
  public static SplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.donorlogo;
      ImageView donorlogo = rootView.findViewById(id);
      if (donorlogo == null) {
        break missingId;
      }

      return new SplashScreenBinding((RelativeLayout) rootView, donorlogo);
    }
