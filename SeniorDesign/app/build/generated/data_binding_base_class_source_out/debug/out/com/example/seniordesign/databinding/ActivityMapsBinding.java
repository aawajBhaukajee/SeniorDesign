...
public final class ActivityMapsBinding implements ViewBinding {
  ...
  private ActivityMapsBinding(@NonNull RelativeLayout rootView,
      @NonNull BottomNavigationView bottomNavigation, @NonNull RelativeLayout mapContainer) {
  ...
  public static ActivityMapsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      RelativeLayout mapContainer = (RelativeLayout) rootView;

      return new ActivityMapsBinding((RelativeLayout) rootView, bottomNavigation, mapContainer);
    }
